...
const Footer = () => {
    ...
    const supportEmail = config?.contact?.email || config?.supportEmail || 'support@digitalstudio.app';
    ...
    return (
        <footer className="ds-page border-t border-slate-200 px-6 py-12">
            <div className="ds-shell grid gap-8 md:grid-cols-[1.2fr,0.8fr,0.8fr]">
                <div className="space-y-4">
                    <div className="inline-flex items-center gap-3">
                        ...
                        <div>
                            <div className="text-sm font-semibold text-slate-900">DigitalStudio</div>
                            <div className="text-sm text-slate-600">Premium ready apps, technical guides, and expert implementation support.</div>
                        </div>
                    </div>
            ...
            <div className="ds-shell mt-8 flex flex-col gap-2 border-t border-slate-200 pt-6 text-sm text-slate-500 md:flex-row md:items-center md:justify-between">
                <p>&copy; {new Date().getFullYear()} DigitalStudio. Powered by Appnity Softwares.</p>
