...
const TestimonialManager = () => {
    ...
    const handleDelete = async () => {
        try {
            ...
            await testimonialService.delete(confirmModal.id);
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500" style={{ fontFamily: "'Inter', sans-serif" }}>
                                ...
                                <tr key={t.id} className="hover:bg-gray-50/50 transition-all group">
                                    ...
                                    <td className="px-10 py-8 text-right">
                                        <div className="flex justify-end gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <button onClick={() => setConfirmModal({ isOpen: true, id: t.id, isLoading: false })} className="p-3 bg-gray-50 text-gray-400 rounded-xl hover:bg-red-500 hover:text-white transition-all border border-gray-100" title="Delete">
            ...
            <ConfirmationModal 
                ...
                onClose={() => setConfirmModal({ isOpen: false, id: null, isLoading: false })}
                onConfirm={handleDelete}
                title="Remove Testimonial?"
                message="This feedback will be permanently erased from the public showcase. This action cannot be undone."
