            ...
            <main className="flex-1 flex flex-col justify-center items-center px-6 sm:px-10 md:px-20 relative bg-white overflow-y-auto">
                ...
                <div className="w-full max-w-[400px] py-20 animate-in fade-in slide-in-from-right-8 duration-700">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button onClick={() => handleOAuth('google')} className="flex items-center justify-center gap-2 py-3.5 bg-white border border-slate-200 rounded-xl text-[10px] font-bold text-slate-600 uppercase hover:bg-slate-50 transition-all shadow-sm active:scale-95">
                             Google
                        </button>
                        <button onClick={() => handleOAuth('github')} className="flex items-center justify-center gap-2 py-3.5 bg-white border border-slate-200 rounded-xl text-[10px] font-bold text-slate-600 uppercase hover:bg-slate-50 transition-all shadow-sm active:scale-95">
                             GitHub
                        </button>
                    </div>
