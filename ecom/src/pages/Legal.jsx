            ...
            <div className="bg-slate-950 py-24 px-6 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <div className="flex items-center gap-4 text-slate-400 text-xs font-bold uppercase tracking-[0.2em]">
                        ...
                        <span>BizCode © Appnity Softwares</span>
                    </div>
                </div>
            </div>
                    ...
                    {isTerms ? (
                        <div className="space-y-12 animate-in fade-in duration-1000">
                            <Section title="1. Definitions">
                                <p>Welcome to <strong>BizCode</strong>. These Terms & Conditions ("Terms") govern your access to and use of the BizCode platform, including any services, digital products, and subscriptions provided by <strong>Appnity Softwares (India)</strong> ("Company," "we," "us," or "our").</p>
                                <ul className="list-disc pl-6 space-y-2 text-slate-600">
                                    <li><strong>Platform</strong>: Refers to https://bizcode.appnity.co.in and all associated subdomains.</li>
                            ...
                            <Section title="5. Payments & Digital Products">
                                ...
                                <div className="p-6 bg-slate-50 border border-slate-100 rounded-2xl">
                                    ...
                                    <p className="text-xs text-slate-500 leading-relaxed font-medium capitalize">Upon purchase, BizCode grants you a non-transferable, non-sublicensable, and non-exclusive license to use the digital product for your projects. Reselling or redistribution is strictly prohibited.</p>
                                </div>
                            </Section>

                            <Section title="6. AI Tools Disclaimer">
                                <p className="text-slate-600 leading-relaxed">BizCode provides AI-powered tools (e.g., Description Generation, Pricing Suggestions). These outputs are generated based on probabilistic models and are intended as <strong>suggestions only</strong>. We do not guarantee the accuracy, legality, or suitability of AI-generated content.</p>
                            </Section>
                        ...
                        <div className="space-y-12 animate-in fade-in duration-1000">
                            <Section title="1. Information Collected">
                                <p className="text-slate-600 mb-4">At BizCode, we respect your privacy. We collect the following types of information:</p>
                                <ul className="list-disc pl-6 space-y-2 text-slate-600">
